...
<div class="navright">
<h2><i class="fa-solid fa-magnifying-glass" style="color:white; margin-top:20px;"></i><i class="fa-solid fa-cart-shopping" style="color:white; margin-inline:30px"></i>  <a href="user/signin.php"> <i class="fa-regular fa-user" style="color:white; margin-inline:7px;"></i></a></h2>
</div>
...
<main>
<div class="firstdiv">
           <h1>Hi mi aahe newtry at your service</h1>        
</div>
</main>
</body>
</html>